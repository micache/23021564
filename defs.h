...
const int CLASS_HP[NUM_CLASS] = {100, 35, 65, 50, 70};
const int CLASS_DAME[NUM_CLASS] = {10, 17, 14, 12, 16};
const int CLASS_COST[NUM_CLASS] = {0, 4, 2, 3, 6};
const int CLASS_STEP[NUM_CLASS] = {0, 4, 3, 5, 3};
